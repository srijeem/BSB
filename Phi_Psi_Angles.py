...
def print_propensities(all_aa_count, buried_aa_count, outfile):
    ...
    #dict_1={'a':sum(buried_aa_count.values()), 'b':sum(all_aa_count.values())  }
    #print (all_aa_count.values())
    #total_ss = dict_1['a'] / dict_1['b']
